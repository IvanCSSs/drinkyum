...
export const metadata: Metadata = {
  ...
  description:
    "Discover YUM — the smoothest botanical extract shot on the market. 255 mg mitragynine per 30ml, no bitterness, lab-tested every batch. Two incredible flavors.",
  robots: { index: false, follow: false }, // Don't index this landing page
  openGraph: {
    title: "DrinkYUM | Premium Botanical Extract Shots",
    description:
      "The smoothest botanical extract shot on the market. 255 mg mitragynine per 30ml, no bitterness, lab-tested every batch. Two incredible flavors.",
    siteName: "DrinkYUM",
    type: "website",
  ...
  twitter: {
    ...
    title: "DrinkYUM | Premium Botanical Extract Shots",
    description:
      "The smoothest botanical extract shot on the market. 255 mg mitragynine per 30ml, no bitterness, lab-tested every batch.",
  },
};
